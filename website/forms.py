...
class LoginForm(FlaskForm):
    ...
    password = PasswordField(
        "Пароль", validators=[DataRequired()], render_kw={"placeholder": "Введите пароль"}
    )
...
class RegisterForm(FlaskForm):
    ...
    confirm_password = PasswordField("Подтверждение пароля",render_kw={"placeholder":"Введите пароль еще раз"})
